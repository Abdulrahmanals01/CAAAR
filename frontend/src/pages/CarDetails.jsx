                ...
                <div className="mb-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    {car.features && typeof car.features === 'string' ? (
                      ...
                      // Fallback if no other features are available - still show insurance
                      <div className="col-span-1 text-gray-500 italic">
